...
fn get_browser_path(browser: &str) -> Option<String> {
    ...
    match browser {
        "Chrome" => {
            ...
            #[cfg(target_os = "linux")]
            return Some(format!("{}/.config/google-chrome/Default/History", home));
        }
        "Brave" => {
            #[cfg(target_os = "macos")]
            return Some(format!(
        ...
        "Firefox" => {
            ...
            #[cfg(target_os = "linux")]
            return Some(format!("{}/.mozilla/firefox", home));
        }
        "Edge" => {
            #[cfg(target_os = "macos")]
            return Some(format!(
            ...
            #[cfg(target_os = "linux")]
            return Some(format!("{}/.config/microsoft-edge/Default/History", home));
        }
        "Safari" => {
            #[cfg(target_os = "macos")]
