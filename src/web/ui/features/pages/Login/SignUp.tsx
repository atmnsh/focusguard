...
export const SignUp = ({
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!emailPattern.test(email)) {
      setErrorMsg("Моля, въведете валиден имейл адрес.");
      return;
    }
    ...
    if (!allowedDomains.includes(emailDomain)) {
      setErrorMsg("Моля, използвайте валиден имейл доставчик (напр. gmail.com, yahoo.com).");
      return;
    }
    ...
    try {
      const response = await invoke("register", { username: email, password: password });
            ...
            <CardContent className="grid p-0 md:grid-cols-2">
              <form className="p-6 md:p-8" onSubmit={handleRegister}>
                <FieldGroup>
                  <div className="flex flex-col items-center gap-2 text-center">
                    <h1 className="text-2xl font-bold">Регистрирайте се</h1>
                    <p className="text-muted-foreground text-sm text-balance">
                      Въведете имейла си за да създадете акаунт
                    </p>
                  </div>
                  {errorMsg && (
                  ...
                  <Field>
                    ...
                    />
                    <FieldDescription>
                      Използваме имейла само за съхраняване на данните. Няма да
                      го споделяме с другите.
                    </FieldDescription>
                  </Field>
                  <Field>
              ...
              <div className="bg-muted relative hidden md:block">
                ...
                <div className="absolute inset-55">
                  <SpriteAnimator animationIndex={3} />
                </div>
              </div>
            </CardContent>
          </Card>
